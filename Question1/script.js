    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "B") {
                feedback.textContent = "✔ Correct! A queue follows the FIFO (First-In-First-Out) principle, meaning elements are inserted at the rear and removed from the front.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is B. A queue follows the FIFO (First-In-First-Out) principle, meaning elements are inserted at the rear and removed from the front.";
                feedback.className = "wrong";
            }
