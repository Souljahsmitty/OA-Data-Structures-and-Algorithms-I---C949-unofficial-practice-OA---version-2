    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! The `Add(int index, Object x)` method inserts an object at the specified index in a list.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect.The correct answer is **A. The `Add(int index, Object x)` method inserts an object at the specified index in a list.";
				feedback.className = "wrong";
			}
        });
    } else {
