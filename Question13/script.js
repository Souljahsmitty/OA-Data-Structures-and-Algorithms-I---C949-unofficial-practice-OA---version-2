    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! The elements in the array contain alphanumeric values, which are best stored as Strings in most programming languages.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: The elements in the array contain alphanumeric values, which are best stored as Strings in most programming languages.";
				feedback.className = "wrong";
			}
        });
    } else {
