    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! In a stack, the push operation adds an element to the top, so 'purple' is added to the right end of the stack.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **C. In a stack, the push operation adds an element to the top, so 'purple' is added to the right end of the stack.";
				feedback.className = "wrong";
			}
        });
    } else {
