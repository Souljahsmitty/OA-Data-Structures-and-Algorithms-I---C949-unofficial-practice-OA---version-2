    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! A List stores elements of the same type and allows retrieval using an index or position.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is C: A List stores elements of the same type and allows retrieval using an index or position.";
				feedback.className = "wrong";
			}
