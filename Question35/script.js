    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! The `Java.io.FileInputStream` class is used to read bytes from a file in Java.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **A. The `Java.io.FileInputStream` class is used to read bytes from a file in Java.";
				feedback.className = "wrong";
			}
        });
    } else {
