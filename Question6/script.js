    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! A Stack follows the LIFO (Last-In-First-Out) principle, allowing insertion and removal only from the top.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: A Stack follows the LIFO (Last-In-First-Out) principle, allowing insertion and removal only from the top.";
				feedback.className = "wrong";
			}
        });
    } else {
