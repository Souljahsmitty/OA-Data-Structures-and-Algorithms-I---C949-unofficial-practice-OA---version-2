    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "A") {
                feedback.textContent = "✔ Correct! Arrays are the most efficient data type for storing a fixed-size sequence of values in Java.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is A. Arrays are the most efficient data type for storing a fixed-size sequence of values in Java.";
                feedback.className = "wrong";
            }
        });
    } else {
