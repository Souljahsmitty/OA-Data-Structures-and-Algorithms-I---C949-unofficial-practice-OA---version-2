    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! Reversing a doubly linked list swaps the direction of links, resulting in 6<-->5<-->4<-->3<-->2<-->1.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **A. Reversing a doubly linked list swaps the direction of links, resulting in 6<-->5<-->4<-->3<-->2<-->1.";
				feedback.className = "wrong";
			}
        });
    } else {
