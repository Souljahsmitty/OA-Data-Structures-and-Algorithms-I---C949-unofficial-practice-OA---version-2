    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! The phone number contains digits, hyphens, and is formatted as text, making String the appropriate data type.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is C: The phone number contains digits, hyphens, and is formatted as text, making String the appropriate data type.";
				feedback.className = "wrong";
			}
        });
    } else {
