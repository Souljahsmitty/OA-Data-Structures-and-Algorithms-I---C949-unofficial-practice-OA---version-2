    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "A") {
                feedback.textContent = "✔ Correct! The variable 'middle' is declared as a char, meaning it must store a single character enclosed in single quotes, like 'D'.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is A. The variable 'middle' is declared as a char, meaning it must store a single character enclosed in single quotes, like 'D'.";
                feedback.className = "wrong";
            }
        });
    } else {
