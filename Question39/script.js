    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! Dictionaries are best used when data is stored as key-value pairs, allowing for quick lookups and retrieval.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **C. Dictionaries are best used when data is stored as key-value pairs, allowing for quick lookups and retrieval.";
				feedback.className = "wrong";
			}
        });
    } else {
