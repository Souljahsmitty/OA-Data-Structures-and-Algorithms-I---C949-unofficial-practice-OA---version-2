    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! The function multiplies an integer by a floating-point constant (3.14), resulting in an implicit conversion to a double.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is C: The function multiplies an integer by a floating-point constant (3.14), resulting in an implicit conversion to a double.";
				feedback.className = "wrong";
			}
        });
    } else {
