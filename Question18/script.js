    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! Linked allocation dynamically assigns memory using pointers, allowing flexibility in storage allocation.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A.Linked allocation dynamically assigns memory using pointers, allowing flexibility in storage allocation.";
				feedback.className = "wrong";
			}
        });
    } else {
