    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! he expression x = y = z = 100 assigns the value 100 to all three variables using the assignment operator '='. ";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: he expression x = y = z = 100 assigns the value 100 to all three variables using the assignment operator '='. ";
				feedback.className = "wrong";
			}
        });
    } else {
