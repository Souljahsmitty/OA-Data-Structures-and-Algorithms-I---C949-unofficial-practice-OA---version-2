    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "B") {
                feedback.textContent = "✔ Correct! The data structure used in the function call is a Tuple, as it groups multiple related values together in an immutable sequence.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect.The correct answer is B. The data structure used in the function call is a Tuple, as it groups multiple related values together in an immutable sequence.";
                feedback.className = "wrong";
            }
        });
    } else {
