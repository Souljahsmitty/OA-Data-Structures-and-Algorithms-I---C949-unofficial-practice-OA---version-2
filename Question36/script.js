    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "D") {
				feedback.textContent = "✔ Correct! The `pop()` method removes and returns the top item of a stack, following the Last-In-First-Out (LIFO) principle.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **D. The `pop()` method removes and returns the top item of a stack, following the Last-In-First-Out (LIFO) principle.";
				feedback.className = "wrong";
			}
        });
    } else {
