    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! In the first iteration, the mid-value is 90. Since 100 is greater than 90, we search in the right half, where the new mid-value is 99.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: In the first iteration, the mid-value is 90. Since 100 is greater than 90, we search in the right half, where the new mid-value is 99.";
				feedback.className = "wrong";
			}
        });
    } else {
