    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! In a stack, the pop operation removes the last item added, which in this case is 'green'. The remaining stack is 'yellow''blue''red'.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **A. In a stack, the pop operation removes the last item added, which in this case is 'green'. The remaining stack is 'yellow''blue''red'.";
				feedback.className = "wrong";
			}
        });
    } else {
