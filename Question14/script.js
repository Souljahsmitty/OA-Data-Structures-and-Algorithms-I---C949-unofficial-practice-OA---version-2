    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! The dataset consists of whole numbers, making the Integer (Int) data type the most suitable choice.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: The dataset consists of whole numbers, making the Integer (Int) data type the most suitable choice.";
				feedback.className = "wrong";
			}
        });
    } else {
