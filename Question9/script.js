    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "A") {
                feedback.textContent = "✔ Correct! The variable Test1 is declared as a char, so it must store a single character enclosed in single quotes, like 'L'.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is A: The variable Test1 is declared as a char, so it must store a single character enclosed in single quotes, like 'L'.";
                feedback.className = "wrong";
            }
        });
    } else {
