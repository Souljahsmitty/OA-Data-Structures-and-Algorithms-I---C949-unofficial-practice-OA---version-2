    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "B") {
                feedback.textContent = "✔ Correct! Queues allow insertion and deletion at both ends, making them useful for handling data from multiple directions.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is B: Queues allow insertion and deletion at both ends, making them useful for handling data from multiple directions.";
                feedback.className = "wrong";
            }
