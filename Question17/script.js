    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! Garbage collection reclaims memory from dynamically allocated data structures, such as linked lists, when they are no longer needed.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: Garbage collection reclaims memory from dynamically allocated data structures, such as linked lists, when they are no longer needed.";
				feedback.className = "wrong";
			}
        });
    } else {
