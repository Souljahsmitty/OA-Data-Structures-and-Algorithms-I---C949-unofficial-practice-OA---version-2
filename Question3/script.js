    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "B") {
                feedback.textContent = "✔ Correct! Stacks follow the LIFO (Last-In-First-Out) principle, meaning elements are inserted and removed only from the top.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is B: Stacks follow the LIFO (Last-In-First-Out) principle, meaning elements are inserted and removed only from the top.";
                feedback.className = "wrong";
            }
