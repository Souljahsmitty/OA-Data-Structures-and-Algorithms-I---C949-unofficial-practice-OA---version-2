    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! function checks the truthiness of the dictionary’s keys, not values. If any key evaluates to True, it returns True.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **A. function checks the truthiness of the dictionary’s keys, not values. If any key evaluates to True, it returns True.";
				feedback.className = "wrong";
			}
        });
    } else {
