    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! In a zero-based indexing system, the indexes for the given list are 0, 1, 2, 3, 4, and 5.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: In a zero-based indexing system, the indexes for the given list are 0, 1, 2, 3, 4, and 5.";
				feedback.className = "wrong";
			}
