    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! Each element in the set represents a sequence of characters, making String the appropriate data type.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is C: Each element in the set represents a sequence of characters, making String the appropriate data type.";
				feedback.className = "wrong";
			}
        });
    } else {
